!function (e, t) {
    ...
    function h(e, t, n, i, r) {
        for (var o, s, a, l, u, h, d = t.createDocumentFragment(), p = [], g = 0, m = e.length; m > g; g++) if ((o = e[g]) || 0 === o) if ("object" === oe.type(o)) oe.merge(p, o.nodeType ? [o] : o); else if (He.test(o)) {
            for (s = s || d.appendChild(t.createElement("div")), a = (je.exec(o) || ["", ""])[1].toLowerCase(), l = Pe[a] || Pe._default, s.innerHTML = l[1] + oe.htmlPrefilter(o) + l[2], h = l[0]; h--;) s = s.lastChild;
            oe.merge(p, s.childNodes), s = d.firstChild, s.textContent = ""
        } else p.push(t.createTextNode(o));
        for (d.textContent = "", g = 0; o = p[g++];) if (i && oe.inArray(o, i) > -1) r && r.push(o); else if (u = oe.contains(o.ownerDocument, o), s = c(d.appendChild(o), "script"), u && f(s), n) for (h = 0; o = s[h++];) Le.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function b(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            xe.hasData(e) && (a = xe.access(e), l = oe.extend({}, a), xe.set(t, l))
        }
    }
    ...
    function E(e, t, n, i) {
        t = z.apply([], t);
        var r, o, s, a, l, u, f = 0, d = e.length, p = d - 1, g = t[0], m = oe.isFunction(g);
        if (m || d > 1 && "string" == typeof g && !ie.checkClone && Be.test(g)) return e.each(function (r) {
            var o = e.eq(r);
            m && (t[0] = g.call(this, r, o.html())), E(o, t, n, i)
        });
        if (d && (r = h(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            ...
            if (a) for (u = s[s.length - 1].ownerDocument, oe.map(s, _), f = 0; a > f; f++) l = s[f], Le.test(l.type || "") && !we.access(l, "globalEval") && oe.contains(u, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace(Ve, "")))
        }
        return e
    }
    ...
    function x(e) {
        var t = G, n = $e[e];
        return n || (n = w(e, t), "none" !== n && n || (Ke = (Ke || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ke[0].contentDocument, t.write(), t.close(), n = w(e, t), Ke.detach()), $e[e] = n), n
    }

    function D(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || Ge(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || oe.contains(e.ownerDocument, e) || (s = oe.style(e, t)), n && !ie.pixelMarginRight() && Ye.test(s) && Qe.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    function I(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += oe.css(e, n + Ie[o], !0, r)), i ? ("content" === n && (s -= oe.css(e, "padding" + Ie[o], !0, r)), "margin" !== n && (s -= oe.css(e, "border" + Ie[o] + "Width", !0, r))) : (s += oe.css(e, "padding" + Ie[o], !0, r), "padding" !== n && (s += oe.css(e, "border" + Ie[o] + "Width", !0, r)));
        return s
    }

    function k(t, n, i) {
        var r = !0, o = "width" === n ? t.offsetWidth : t.offsetHeight, s = Ge(t),
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = D(t, n, s), (0 > o || null == o) && (o = t.style[n]), Ye.test(o)) return o;
    ...
    function O(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (o[s] = we.get(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && ke(i) && (o[s] = we.access(i, "olddisplay", x(i.nodeName)))) : (r = ke(i), "none" === n && r || we.set(i, "olddisplay", r ? n : oe.css(i, "display"))));
    ...
    function R(e, t, n) {
        var i, r, o, s, a, l, u, c = this, f = {}, h = e.style, d = e.nodeType && ke(e), p = we.get(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = oe.css(e, "display"), "inline" === ("none" === u ? we.get(e, "olddisplay") || x(e.nodeName) : u) && "none" === oe.css(e, "float") && (h.display = "inline-block")), n.overflow && (h.overflow = "hidden", c.always(function () {
        ...
        if (oe.isEmptyObject(f)) "inline" === ("none" === u ? x(e.nodeName) : u) && (h.display = u); else {
            p ? "hidden" in p && (d = p.hidden) : p = we.access(e, "fxshow", {}), o && (p.hidden = !d), d ? oe(e).show() : c.done(function () {
                oe(e).hide()
            }), c.done(function () {
                var t;
                we.remove(e, "fxshow");
            ...
            for (i in f) s = H(d ? p[i] : 0, i, c), i in p || (p[i] = s.start, d && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function M(e, t, n) {
        var i, r, o = 0, s = M.prefilters.length, a = oe.Deferred().always(function () {
            ...
            if (r) return !1;
            for (var t = it || L(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
    ...
    function $(e, t, n, i) {
        ...
        }); else if (n || "object" !== oe.type(t)) i(e, t); else for (r in t) $(e + "[" + r + "]", t[r], n, i)
    }
    ...
    var Y = [], G = e.document, X = Y.slice, z = Y.concat, J = Y.push, Z = Y.indexOf, ee = {}, te = ee.toString,
    ...
    oe.fn = oe.prototype = {
        ...
        expando: "jQuery" + (re + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i, r;
            return "string" == typeof t && (n = e[t], t = e, e = n), oe.isFunction(e) ? (i = X.call(arguments, 2), r = function () {
    ...
    var ce = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : q) !== O && k(t), t = t || O, L)) {
                if (11 !== g && (u = ve.exec(e))) if (r = u[1]) {
                    if (9 === g) {
        ...
        function d(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (s) {
                    ...
                    if (u = t[M] || (t[M] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[i]) && a[0] === W && a[1] === o) return c[2] = a[2];
        ...
        function v(e, t, n, r, o, s) {
            return r && !r[M] && (r = v(r)), o && !o[M] && (o = v(o, s)), i(function (i, s, a, l) {
                var u, c, f, h = [], d = [], p = s.length, v = i || g(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !i && t ? v : m(v, h, e, a, l), _ = n ? o || (i ? e : p || r) ? [] : s : y;
                if (n && n(y, _, a, l), r) for (u = m(_, d), r(u, [], a, l), c = u.length; c--;) (f = u[c]) && (_[d[c]] = !(y[d[c]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, i, r = e.length, o = E.relative[e[0].type], s = o || E.relative[" "], a = o ? 1 : 0, l = d(function (e) {
                ...
                return t = null, r
            }]; r > a; a++) if (n = E.relative[e[a].type]) c = [d(p(c), n)]; else {
                if (n = E.filter[e[a].type].apply(null, e[a].matches), n[M]) {
                    for (i = ++a; r > i && !E.relative[e[i].type]; i++) ;
                    return v(a > 1 && p(c), a > 1 && h(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ae, "$1"), n, i > a && y(e.slice(a, i)), r > i && y(e = e.slice(i)), r > i && h(e))
                }
                c.push(n)
            }
            return p(c)
        ...
        function _(e, n) {
            var r = n.length > 0, o = e.length > 0, s = function (i, s, a, l, u) {
                var c, f, h, d = 0, p = "0", g = i && [], v = [], y = A, _ = i || o && E.find.TAG("*", u),
                    b = W += null == y ? 1 : Math.random() || .1, T = _.length;
                for (u && (A = s === O || s || u); p !== T && null != (c = _[p]); p++) {
                    if (o && c) {
                        for (f = 0, s || c.ownerDocument === O || (k(c), a = !L); h = e[f++];) if (h(c, s || O, a)) {
                            l.push(c);
                            break
                        }
                        u && (W = b)
                ...
                if (d += p, r && p !== d) {
                    ...
                    if (i) {
                        if (d > 0) for (; p--;) g[p] || v[p] || (v[p] = X.call(l));
                        v = m(v)
                    }
        ...
        var b, T, E, C, w, x, D, S, A, N, I, k, O, j, L, P, H, R, F, M = "sizzle" + 1 * new Date, q = e.document, W = 0,
            B = 0, U = n(), V = n(), K = n(), $ = function (e, t) {
                return e === t && (I = !0), 0
            }, Q = 1 << 31, Y = {}.hasOwnProperty, G = [], X = G.pop, z = G.push, J = G.push, Z = G.slice,
            ee = function (e, t) {
            ...
            ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, _e = /'|\\/g,
            be = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), Te = function (e, t, n) {
                var i = "0x" + t - 65536;
        ...
        T = t.support = {}, w = t.isXML = function (e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, j = O.documentElement, L = !w(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ee, !1) : n.attachEvent && n.attachEvent("onunload", Ee)), T.attributes = r(function (e) {
                ...
                return j.appendChild(e).id = M, !O.getElementsByName || !O.getElementsByName(M).length
            ...
            }, H = [], P = [], (T.qsa = me.test(O.querySelectorAll)) && (r(function (e) {
            ...
            })), (T.matchesSelector = me.test(R = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && r(function (e) {
                T.disconnectedMatch = R.call(e, "div"), R.call(e, "[s!='']:x"), H.push("!=", oe)
            }), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), t = me.test(j.compareDocumentPosition), F = t || me.test(j.contains) ? function (e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === q && F(q, e) ? -1 : t === O || t.ownerDocument === q && F(q, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return I = !0, 0;
                var n, i = 0, r = e.parentNode, o = t.parentNode, a = [e], l = [t];
                if (!r || !o) return e === O ? -1 : t === O ? 1 : r ? -1 : o ? 1 : N ? ee(N, e) - ee(N, t) : 0;
                if (r === o) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== O && k(e), n = n.replace(ce, "='$1']"), T.matchesSelector && L && !K[n + " "] && (!H || !H.test(n)) && (!P || !P.test(n))) try {
                var i = R.call(e, n);
            ...
            return (e.ownerDocument || e) !== O && k(e), F(e, t)
        }, t.attr = function (e, t) {
            (e.ownerDocument || e) !== O && k(e);
            var n = E.attrHandle[t.toLowerCase()],
                i = n && Y.call(E.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
            return void 0 !== i ? i : T.attributes || !L ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null
        }, t.error = function (e) {
            throw new Error("Syntax error, unrecognized expression: " + e)
        }, t.uniqueSort = function (e) {
            var t, n = [], i = 0, r = 0;
            if (I = !T.detectDuplicates, N = !T.sortStable && e.slice(0), e.sort($), I) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        var u, c, f, h, d, p, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                for (h = m, f = h[M] || (h[M] = {}), c = f[h.uniqueID] || (f[h.uniqueID] = {}), u = c[e] || [], d = u[0] === W && u[1], _ = d && u[2], h = d && m.childNodes[d]; h = ++d && h && h[g] || (_ = d = 0) || p.pop();) if (1 === h.nodeType && ++_ && h === t) {
                                    c[e] = [W, d, _];
                                    break
                                }
                            } else if (y && (h = t, f = h[M] || (h[M] = {}), c = f[h.uniqueID] || (f[h.uniqueID] = {}), u = c[e] || [], d = u[0] === W && u[1], _ = d), !1 === _) for (; (h = ++d && h && h[g] || (_ = d = 0) || p.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++_ || (y && (f = h[M] || (h[M] = {}), c = f[h.uniqueID] || (f[h.uniqueID] = {}), c[e] = [W, _]), h !== t));) ;
                            return (_ -= r) === i || _ % i == 0 && _ / i >= 0
                        }
                    }
                }, PSEUDO: function (e, n) {
                    var r, o = E.pseudos[e] || E.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                    return o[M] ? o(n) : o.length > 1 ? (r = [e, e, "", n], E.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
            ...
            pseudos: {
                not: i(function (e) {
                    ...
                    return he.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(be, Te).toLowerCase(), function (t) {
                        var n;
                        do {
        ...
        return f.prototype = E.filters = E.pseudos, E.setFilters = new f, x = t.tokenize = function (e, n) {
            ...
            for (a = e, l = [], u = E.preFilter; a;) {
                ...
                for (s in E.filter) !(r = de[s].exec(a)) || u[s] && !(r = u[s](r)) || (i = r.shift(), o.push({
                    value: i,
                    type: s,
                    matches: r
                }), a = a.slice(i.length));
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && T.getById && 9 === t.nodeType && L && E.relative[o[1].type]) {
                    if (!(t = (E.find.ID(s.matches[0].replace(be, Te), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = de.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !E.relative[a = s.type]);) if ((l = E.find[a]) && (i = l(s.matches[0].replace(be, Te), ye.test(o[0].type) && c(t.parentNode) || t))) {
                    if (o.splice(r, 1), !(e = i.length && h(o))) return J.apply(n, i), n;
                    break
                }
            }
            return (u || D(e, f))(i, t, !L, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, T.sortStable = M.split("").sort($).join("") === M, T.detectDuplicates = !!I, k(), T.sortDetached = r(function (e) {
    ...
    var ye = /^(?:parents|prev(?:Until|All))/, _e = {children: !0, contents: !0, next: !0, prev: !0};
    oe.fn.extend({
        has: function (e) {
        ...
        oe.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = oe.filter(i, r)), this.length > 1 && (_e[e] || oe.uniqueSort(r), ye.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var be = /\S+/g;
    oe.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, r = 0, o = X.call(arguments), s = o.length,
    ...
    oe.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            (!0 === e ? --oe.readyWait : oe.isReady) || (oe.isReady = !0, !0 !== e && --oe.readyWait > 0 || (Te.resolveWith(G, [oe]), oe.fn.triggerHandler && (oe(G).triggerHandler("ready"), oe(G).off("ready"))))
        }
    ...
    var we = new a, xe = new a, De = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Se = /[A-Z]/g;
    oe.extend({
        hasData: function (e) {
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = xe.get(o), 1 === o.nodeType && !we.get(o, "hasDataAttrs"))) {
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                if (o && void 0 === t) {
                    ...
                    if (i = oe.camelCase(e), void 0 !== (n = xe.get(o, i))) return n;
    ...
    var Ae = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ne = new RegExp("^(?:([+-])=|)(" + Ae + ")([a-z%]*)$", "i"),
        Ie = ["Top", "Right", "Bottom", "Left"], ke = function (e, t) {
            return e = t || e, "none" === oe.css(e, "display") || !oe.contains(e.ownerDocument, e)
        }, Oe = /^(?:checkbox|radio)$/i, je = /<([\w:-]+)/, Le = /^$|\/(?:java|ecma)script/i, Pe = {
    ...
    var Re = /^key/, Fe = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Me = /^([^.]*)(?:\.(.+)|)/;
    oe.event = {
        global: {},
        add: function (e, t, n, i, r) {
            var o, s, a, l, u, c, f, h, d, p, g, m = we.get(e);
            if (m) for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = oe.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
            ...
            }), t = (t || "").match(be) || [""], u = t.length; u--;) a = Me.exec(t[u]) || [], d = g = a[1], p = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                type: d,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: p.join(".")
            }, o), (h = l[d]) || (h = l[d] = [], h.delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(d, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? h.splice(h.delegateCount++, 0, c) : h.push(c), oe.event.global[d] = !0)
        },
        remove: function (e, t, n, i, r) {
            var o, s, a, l, u, c, f, h, d, p, g, m = we.hasData(e) && we.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(be) || [""], u = t.length; u--;) if (a = Me.exec(t[u]) || [], d = g = a[1], p = (a[2] || "").split(".").sort(), d) {
                    ...
                    s && !h.length && (f.teardown && !1 !== f.teardown.call(e, p, m.handle) || oe.removeEvent(e, d, m.handle), delete l[d])
        ...
        dispatch: function (e) {
            e = oe.event.fix(e);
            var t, n, i, r, o, s = [], a = X.call(arguments), l = (we.get(this, "events") || {})[e.type] || [],
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[r] = s = Fe.test(r) ? this.mouseHooks : Re.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
        ...
        return this instanceof oe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? d : p) : this.type = e, t && oe.extend(this, t), this.timeStamp = e && e.timeStamp || oe.now(), void (this[oe.expando] = !0)) : new oe.Event(e, t)
    }, oe.Event.prototype = {
    ...
    var qe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, We = /<script|<style|<link/i,
        Be = /checked\s*(?:[^=]|=\s*.checked.)/i, Ue = /^true\/(.*)/, Ve = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    oe.extend({
    ...
    var Ke, $e = {HTML: "block", BODY: "block"}, Qe = /^margin/, Ye = new RegExp("^(" + Ae + ")(?!px)[a-z%]+$", "i"),
        Ge = function (t) {
    ...
    !function () {
        function t() {
            ...
            n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, ze.removeChild(s)
        }
    ...
    var Je = /^(none|table(?!-c[ea]).+)/, Ze = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    oe.extend({
        ...
        css: function (e, t, n, i) {
            ...
            return t = oe.cssProps[a] || (oe.cssProps[a] = A(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = D(e, t, i)), "normal" === r && t in et && (r = et[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), oe.each(["height", "width"], function (e, t) {
        oe.cssHooks[t] = {
            get: function (e, n, i) {
                return n ? Je.test(oe.css(e, "display")) && 0 === e.offsetWidth ? Xe(e, Ze, function () {
                    return k(e, t, i)
                }) : k(e, t, i) : void 0
            }, set: function (e, n, i) {
                var r, o = i && Ge(e), s = i && I(e, t, i, "border-box" === oe.css(e, "boxSizing", !1, o), o);
                return s && (r = Ne.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), N(e, n, s)
            }
        }
    }), oe.cssHooks.marginLeft = S(ie.reliableMarginLeft, function (e, t) {
        return t ? (parseFloat(D(e, "marginLeft")) || e.getBoundingClientRect().left - Xe(e, {marginLeft: 0}, function () {
            return e.getBoundingClientRect().left
        })) + "px" : void 0
    }), oe.cssHooks.marginRight = S(ie.reliableMarginRight, function (e, t) {
        return t ? Xe(e, {display: "inline-block"}, D, [e, "marginRight"]) : void 0
        ...
        }, Qe.test(e) || (oe.cssHooks[e + t].set = N)
    }), oe.fn.extend({
        css: function (e, t) {
            return Ee(this, function (e, t, n) {
                var i, r, o = {}, s = 0;
                if (oe.isArray(t)) {
                    for (i = Ge(e), r = t.length; r > s; s++) o[t[s]] = oe.css(e, t[s], !1, i);
                    return o
                }
    ...
    oe.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? oe.prop(e, t, n) : (1 === o && oe.isXMLDoc(e) || (t = t.toLowerCase(), r = oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? at : void 0)), void 0 !== n ? null === n ? void oe.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = oe.find.attr(e, t), null == i ? void 0 : i))
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    oe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(be) || []; n = this[l++];) if (r = q(n), i = 1 === n.nodeType && (" " + r + " ").replace(ft, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, o;
                if ("string" === n) for (i = 0, r = oe(this), o = e.match(be) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else (void 0 === e || "boolean" === n) && (t = q(this), t && we.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : we.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    oe.extend(oe.event, {
        trigger: function (t, n, i, r) {
            var o, s, a, l, u, c, f, h = [i || G], d = ne.call(t, "type") ? t.type : t,
                p = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !dt.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (p = d.split("."), d = p.shift(), p.sort()), u = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!r && !f.noBubble && !oe.isWindow(i)) {
                    for (l = f.delegateType || d, dt.test(l + d) || (s = s.parentNode); s; s = s.parentNode) h.push(s), a = s;
                    a === (i.ownerDocument || G) && h.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = h[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || d, c = (we.get(s, "events") || {})[t.type] && we.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Ce(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = d, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), n) || !Ce(i) || u && oe.isFunction(i[d]) && !oe.isWindow(i) && (a = i[u], a && (i[u] = null), oe.event.triggered = d, i[d](), oe.event.triggered = void 0, a && (i[u] = a)), t.result
            }
    ...
    var pt = e.location, gt = oe.now(), mt = /\?/;
    ...
    var vt = /#.*$/, yt = /([?&])_=[^&]*/, _t = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        bt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Tt = /^(?:GET|HEAD)$/, Et = /^\/\//, Ct = {},
        wt = {}, xt = "*/".concat("*"), Dt = G.createElement("a");
    Dt.href = pt.href, oe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, n) {
            ...
            var r, o, s, a, l, u, c, f, h = oe.ajaxSetup({}, n), d = h.context || h,
                ...
                m = oe.Callbacks("once memory"), v = h.statusCode || {}, y = {}, _ = {}, b = 0, T = "canceled", E = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        var t;
                        if (e) if (2 > b) for (t in e) v[t] = [v[t], e[t]]; else E.always(e[E.status]);
                        return this
                    }, abort: function (e) {
                        var t = e || T;
            ...
            if (g.promise(E).complete = m.add, E.success = E.done, E.error = E.fail, h.url = ((t || h.url || pt.href) + "").replace(vt, "").replace(Et, pt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = oe.trim(h.dataType || "*").toLowerCase().match(be) || [""], null == h.crossDomain) {
                u = G.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = oe.param(h.data, h.traditional)), B(Ct, h, n, E), 2 === b) return E;
            c = oe.event && h.global, c && 0 == oe.active++ && oe.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Tt.test(h.type), o = h.url, h.hasContent || (h.data && (o = h.url += (mt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (h.url = yt.test(o) ? o.replace(yt, "$1_=" + gt++) : o + (mt.test(o) ? "&" : "?") + "_=" + gt++)), h.ifModified && (oe.lastModified[o] && E.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && E.setRequestHeader("If-None-Match", oe.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + xt + "; q=0.01" : "") : h.accepts["*"]);
            for (f in h.headers) E.setRequestHeader(f, h.headers[f]);
            if (h.beforeSend && (!1 === h.beforeSend.call(d, E, h) || 2 === b)) return E.abort();
            T = "abort";
            for (f in {success: 1, error: 1, complete: 1}) E[f](h[f]);
            if (r = B(wt, h, n, E)) {
                if (E.readyState = 1, c && p.trigger("ajaxSend", [E, h]), 2 === b) return E;
    ...
    oe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && kt.test(this.nodeName) && !It.test(e) && (this.checked || !Oe.test(e))
            }).map(function (e, t) {
                var n = oe(this).val();
    ...
    var Ot = {0: 200, 1223: 204}, jt = oe.ajaxSettings.xhr();
    ...
    oe.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + r) : !1 !== t.jsonp && (t.url += (mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return s || oe.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === o ? oe(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Lt.push(r)), s && oe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script") : void 0
    ...
    oe.fn.load = function (e, t, n) {
        ...
        oe.cssHooks[t] = S(ie.pixelPosition, function (e, n) {
            return n ? (n = D(e, t), Ye.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    ...
    return oe.noConflict = function (t) {
        return e.$ === oe && (e.$ = Ft), t && e.jQuery === oe && (e.jQuery = Rt), oe
    }, t || (e.jQuery = e.$ = oe), oe
}), function (e, t) {
    ...
    var s, a, l, u, c, f, h, d, p, g, m, v, y, _, b, T, E, C, w, x, D, S, A, N, I, k, O, j, L, P, H, R, F, M, q, W, B,
        U, V, K, $, Q, Y, G, X, z, J, Z, ee, te, ne, ie, re, oe, se, ae, le, ue, ce, fe, he, de, pe, ge, me, ve, ye, _e,
        be, Te, Ee, Ce, we, xe, De, Se, Ae, Ne, Ie, ke, Oe, je, Le, Pe, He, Re, Fe, Me, qe, We, Be, Ue, Ve, Ke, $e, Qe,
        Ye, Ge, Xe, ze, Je, Ze, et, tt, nt, it, rt, ot, st, at, lt, ut, ct, ft, ht, dt, pt, gt, mt, vt, yt, _t, bt, Tt,
        Et, Ct, wt, xt, Dt, St, At, Nt, It, kt, Ot, jt, Lt, Pt, Ht, Rt, Ft, Mt, qt, Wt, Bt, Ut, Vt, Kt, $t, Qt, Yt, Gt,
        Xt, zt, Jt, Zt, en, tn, nn, rn, on, sn, an, ln, un, cn, fn, hn, dn, pn, gn, mn, vn, yn, _n, bn, Tn,
        En = function (e) {
            function t(t) {
                var n = this, r = !1;
        ...
        }(t), Cn = (a = "alert", u = "." + (l = "bs.alert"), c = (s = t).fn[a], f = {
            CLOSE: "close" + u,
            CLOSED: "closed" + u,
            ...
            return t.close = function (e) {
                ...
                var t = En.getSelectorFromElement(e), n = !1;
                ...
                if (s(e).removeClass(p), s(e).hasClass(d)) {
                    var n = En.getTransitionDurationFromElement(e);
                    s(e).one(En.TRANSITION_END, function (n) {
        ...
        wn = (v = "button", _ = "." + (y = "bs.button"), b = ".data-api", T = (m = t).fn[v], E = "active", C = "btn", x = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", A = ".active", N = ".btn", I = {
            CLICK_DATA_API: "click" + _ + b,
            FOCUS_BLUR_DATA_API: (w = "focus") + _ + b + " blur" + _ + b
        }, k = function () {
            function e(e) {
                this._element = e
            }
            ...
            return t.toggle = function () {
                var e = !0, t = !0, n = m(this._element).closest(D)[0];
                if (n) {
                    var i = m(this._element).find(S)[0];
                    if (i) {
                        if ("radio" === i.type) if (i.checked && m(this._element).hasClass(E)) e = !1; else {
                            var r = m(n).find(A)[0];
                            r && m(r).removeClass(E)
                        }
                        if (e) {
        ...
        }, k), xn = (j = "carousel", P = "." + (L = "bs.carousel"), H = ".data-api", R = (O = t).fn[j], F = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            wrap: "boolean"
        }, q = "next", W = "prev", B = "left", U = "right", V = {
            SLIDE: "slide" + P,
            SLID: "slid" + P,
            KEYDOWN: "keydown" + P,
        ...
        }, K = "carousel", $ = "active", Q = "slide", Y = "carousel-item-right", G = "carousel-item-left", X = "carousel-item-next", z = "carousel-item-prev", J = {
            ACTIVE: ".active",
            ...
            function e(e, t) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = O(e)[0], this._indicatorsElement = O(this._element).find(J.INDICATORS)[0], this._addEventListeners()
            }
            ...
            return t.next = function () {
                ...
                e || (this._isPaused = !0), O(this._element).find(J.NEXT_PREV)[0] && (En.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, t.cycle = function (e) {
                e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }, t.to = function (e) {
                var t = this;
                this._activeElement = O(this._element).find(J.ACTIVE_ITEM)[0];
                var n = this._getItemIndex(this._activeElement);
                if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) O(this._element).one(V.SLID, function () {
                    return t.to(e)
                }); else {
                ...
                return e = o({}, F, e), En.typeCheckConfig(j, e, M), e
            }, t._addEventListeners = function () {
                var e = this;
                this._config.keyboard && O(this._element).on(V.KEYDOWN, function (t) {
                    return e._keydown(t)
                }), "hover" === this._config.pause && (O(this._element).on(V.MOUSEENTER, function (t) {
                    return e.pause(t)
                }).on(V.MOUSELEAVE, function (t) {
                    return e.cycle(t)
                }), "ontouchstart" in document.documentElement && O(this._element).on(V.TOUCHEND, function () {
                ...
                return this._items = O.makeArray(O(e).parent().find(J.ITEM)), this._items.indexOf(e)
            }, t._getItemByDirection = function (e, t) {
                var n = e === q, i = e === W, r = this._getItemIndex(t), o = this._items.length - 1;
                if ((i && 0 === r || n && r === o) && !this._config.wrap) return t;
                var s = (r + (e === W ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, t._triggerSlideEvent = function (e, t) {
                var n = this._getItemIndex(e), i = this._getItemIndex(O(this._element).find(J.ACTIVE_ITEM)[0]),
                    r = O.Event(V.SLIDE, {relatedTarget: e, direction: t, from: i, to: n});
                return O(this._element).trigger(r), r
            }, t._setActiveIndicatorElement = function (e) {
                if (this._indicatorsElement) {
                    O(this._indicatorsElement).find(J.ACTIVE).removeClass($);
                    var t = this._indicatorsElement.children[this._getItemIndex(e)];
                    t && O(t).addClass($)
                }
            }, t._slide = function (e, t) {
                var n, i, r, o = this, s = O(this._element).find(J.ACTIVE_ITEM)[0], a = this._getItemIndex(s),
                    l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
                if (e === q ? (n = G, i = X, r = B) : (n = Y, i = z, r = U), l && O(l).hasClass($)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                    var f = O.Event(V.SLID, {relatedTarget: l, direction: r, from: a, to: u});
                    if (O(this._element).hasClass(Q)) {
                        O(l).addClass(i), En.reflow(l), O(s).addClass(n), O(l).addClass(n);
                        var h = En.getTransitionDurationFromElement(s);
                        O(s).one(En.TRANSITION_END, function () {
                            O(l).removeClass(n + " " + i).addClass($), O(s).removeClass($ + " " + i + " " + n), o._isSliding = !1, setTimeout(function () {
                                return O(o._element).trigger(f)
                            }, 0)
                        }).emulateTransitionEnd(h)
                    } else O(s).removeClass($), O(l).addClass($), this._isSliding = !1, O(this._element).trigger(f);
                    c && this.cycle()
                }
            }, e._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = O(this).data(L), i = o({}, F, O(this).data());
        ...
        }(), O(document).on(V.CLICK_DATA_API, J.DATA_SLIDE, Z._dataApiClickHandler), O(window).on(V.LOAD_DATA_API, function () {
            O(J.DATA_RIDE).each(function () {
                var e = O(this);
                Z._jQueryInterface.call(e, e.data())
            })
        }), O.fn[j] = Z._jQueryInterface, O.fn[j].Constructor = Z, O.fn[j].noConflict = function () {
            return O.fn[j] = R, Z._jQueryInterface
        }, Z), Dn = (te = "collapse", ie = "." + (ne = "bs.collapse"), re = (ee = t).fn[te], oe = {
            toggle: !0,
            parent: ""
        }, se = {toggle: "boolean", parent: "(string|element)"}, ae = {
            SHOW: "show" + ie,
            SHOWN: "shown" + ie,
            HIDE: "hide" + ie,
            HIDDEN: "hidden" + ie,
            CLICK_DATA_API: "click" + ie + ".data-api"
        }, le = "show", ue = "collapse", ce = "collapsing", fe = "collapsed", he = "width", de = "height", pe = {
            ...
            function e(e, t) {
                ...
                for (var n = ee(pe.DATA_TOGGLE), i = 0; i < n.length; i++) {
                    var r = n[i], o = En.getSelectorFromElement(r);
            ...
            return t.toggle = function () {
                ...
                var t, n, i = this;
                if (!(this._isTransitioning || ee(this._element).hasClass(le) || (this._parent && 0 === (t = ee.makeArray(ee(this._parent).find(pe.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (t = null), t && (n = ee(t).not(this._selector).data(ne)) && n._isTransitioning))) {
                    ...
                    if (ee(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        ee(this._element).removeClass(ue).addClass(ce), (this._element.style[o] = 0) < this._triggerArray.length && ee(this._triggerArray).removeClass(fe).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var s = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                            a = En.getTransitionDurationFromElement(this._element);
                        ee(this._element).one(En.TRANSITION_END, function () {
                            ee(i._element).removeClass(ce).addClass(ue).addClass(le), i._element.style[o] = "", i.setTransitioning(!1), ee(i._element).trigger(ae.SHOWN)
                ...
                if (!this._isTransitioning && ee(this._element).hasClass(le)) {
                    ...
                    if (ee(this._element).trigger(t), !t.isDefaultPrevented()) {
                        ...
                        if (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", En.reflow(this._element), ee(this._element).addClass(ce).removeClass(ue).removeClass(le), 0 < this._triggerArray.length) for (var i = 0; i < this._triggerArray.length; i++) {
                            var r = this._triggerArray[i], o = En.getSelectorFromElement(r);
                            null !== o && (ee(o).hasClass(le) || ee(r).addClass(fe).attr("aria-expanded", !1))
                        }
                        this.setTransitioning(!0), this._element.style[n] = "";
                        var s = En.getTransitionDurationFromElement(this._element);
                        ee(this._element).one(En.TRANSITION_END, function () {
                ...
                return (e = o({}, oe, e)).toggle = Boolean(e.toggle), En.typeCheckConfig(te, e, se), e
            }, t._getDimension = function () {
                return ee(this._element).hasClass(he) ? he : de
            }, t._getParent = function () {
                var t = this, n = null;
                En.isElement(this._config.parent) ? (n = this._config.parent, void 0 !== this._config.parent.jquery && (n = this._config.parent[0])) : n = ee(this._config.parent)[0];
                ...
                if (e) {
                    ...
                    0 < t.length && ee(t).toggleClass(fe, !n).attr("aria-expanded", n)
                }
                ...
                return this.each(function () {
                    var n = ee(this), i = n.data(ne), r = o({}, oe, n.data(), "object" == typeof t && t);
            ...
            var t = ee(this), n = En.getSelectorFromElement(this);
            ee(n).each(function () {
        ...
        Sn = (ve = "dropdown", _e = "." + (ye = "bs.dropdown"), be = ".data-api", Te = (me = t).fn[ve], Ee = new RegExp("38|40|27"), Ce = {
            HIDE: "hide" + _e,
            HIDDEN: "hidden" + _e,
            SHOW: "show" + _e,
            SHOWN: "shown" + _e,
            ...
            return t.toggle = function () {
                if (!this._element.disabled && !me(this._element).hasClass(we)) {
                    var t = e._getParentFromElement(this._element), i = me(this._menu).hasClass(xe);
                    if (e._clearMenus(), !i) {
                        var r = {relatedTarget: this._element}, o = me.Event(Ce.SHOW, r);
                        if (me(t).trigger(o), !o.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                if (void 0 === n) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)");
                                var s = this._element;
                                "parent" === this._config.reference ? s = t : En.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && me(t).addClass(Ie), this._popper = new n(s, this._menu, this._getPopperConfig())
                            }
                ...
                return e = o({}, this.constructor.Default, me(this._element).data(), e), En.typeCheckConfig(ve, e, this.constructor.DefaultType), e
                ...
                var e = me(this._element).parent(), t = Fe;
                return e.hasClass(De) ? (t = He, me(this._menu).hasClass(Ne) && (t = Re)) : e.hasClass(Se) ? t = qe : e.hasClass(Ae) ? t = We : me(this._menu).hasClass(Ne) && (t = Me), t
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var n = me.makeArray(me(ke)), i = 0; i < n.length; i++) {
                    var r = e._getParentFromElement(n[i]), o = me(n[i]).data(ye), s = {relatedTarget: n[i]};
                    if (o) {
                        var a = o._menu;
                        if (me(r).hasClass(xe) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && me.contains(r, t.target))) {
                            ...
                            me(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && me(document.body).children().off("mouseover", null, me.noop), n[i].setAttribute("aria-expanded", "false"), me(a).removeClass(xe), me(r).removeClass(xe).trigger(me.Event(Ce.HIDDEN, s)))
                        }
                    }
                }
            }, e._getParentFromElement = function (e) {
                var t, n = En.getSelectorFromElement(e);
                return n && (t = me(n)[0]), t || e.parentNode
            }, e._dataApiKeydownHandler = function (t) {
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || me(t.target).closest(je).length)) : Ee.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !me(this).hasClass(we))) {
                    var n = e._getParentFromElement(this), i = me(n).hasClass(xe);
        ...
        }(), me(document).on(Ce.KEYDOWN_DATA_API, ke, Ve._dataApiKeydownHandler).on(Ce.KEYDOWN_DATA_API, je, Ve._dataApiKeydownHandler).on(Ce.CLICK_DATA_API + " " + Ce.KEYUP_DATA_API, Ve._clearMenus).on(Ce.CLICK_DATA_API, ke, function (e) {
            e.preventDefault(), e.stopPropagation(), Ve._jQueryInterface.call(me(this), "toggle")
        }).on(Ce.CLICK_DATA_API, Oe, function (e) {
            e.stopPropagation()
        }), me.fn[ve] = Ve._jQueryInterface, me.fn[ve].Constructor = Ve, me.fn[ve].noConflict = function () {
            return me.fn[ve] = Te, Ve._jQueryInterface
        }, Ve), An = ($e = "modal", Ye = "." + (Qe = "bs.modal"), Ge = (Ke = t).fn[$e], Xe = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            function e(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = Ke(e).find(rt.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0
            }
            ...
            return t.toggle = function (e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    Ke(this._element).hasClass(nt) && (this._isTransitioning = !0);
                    var n = Ke.Event(Je.SHOW, {relatedTarget: e});
                    Ke(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), Ke(document.body).addClass(tt), this._setEscapeEvent(), this._setResizeEvent(), Ke(this._element).on(Je.CLICK_DISMISS, rt.DATA_DISMISS, function (e) {
                        return t.hide(e)
                    }), Ke(this._dialog).on(Je.MOUSEDOWN_DISMISS, function () {
                        Ke(t._element).one(Je.MOUSEUP_DISMISS, function (e) {
                            Ke(e.target).is(t._element) && (t._ignoreBackdropClick = !0)
                        })
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    var n = Ke.Event(Je.HIDE);
                    if (Ke(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var i = Ke(this._element).hasClass(nt);
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), Ke(document).off(Je.FOCUSIN), Ke(this._element).removeClass(it), Ke(this._element).off(Je.CLICK_DISMISS), Ke(this._dialog).off(Je.MOUSEDOWN_DISMISS), i) {
                            var r = En.getTransitionDurationFromElement(this._element);
                            Ke(this._element).one(En.TRANSITION_END, function (e) {
                ...
                return e = o({}, Xe, e), En.typeCheckConfig($e, e, ze), e
            }, t._showElement = function (e) {
                var t = this, n = Ke(this._element).hasClass(nt);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && En.reflow(this._element), Ke(this._element).addClass(it), this._config.focus && this._enforceFocus();
                var i = Ke.Event(Je.SHOWN, {relatedTarget: e}), r = function () {
                    t._config.focus && t._element.focus(), t._isTransitioning = !1, Ke(t._element).trigger(i)
                };
                if (n) {
                    var o = En.getTransitionDurationFromElement(this._element);
                    Ke(this._dialog).one(En.TRANSITION_END, r).emulateTransitionEnd(o)
                } else r()
            }, t._enforceFocus = function () {
                var e = this;
                Ke(document).off(Je.FOCUSIN).on(Je.FOCUSIN, function (t) {
                    document !== t.target && e._element !== t.target && 0 === Ke(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? Ke(this._element).on(Je.KEYDOWN_DISMISS, function (t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || Ke(this._element).off(Je.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function () {
                var e = this;
                this._isShown ? Ke(window).on(Je.RESIZE, function (t) {
                    return e.handleUpdate(t)
                }) : Ke(window).off(Je.RESIZE)
            }, t._hideModal = function () {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function () {
                    Ke(document.body).removeClass(tt), e._resetAdjustments(), e._resetScrollbar(), Ke(e._element).trigger(Je.HIDDEN)
                })
            }, t._removeBackdrop = function () {
                this._backdrop && (Ke(this._backdrop).remove(), this._backdrop = null)
            }, t._showBackdrop = function (e) {
                var t = this, n = Ke(this._element).hasClass(nt) ? nt : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = et, n && Ke(this._backdrop).addClass(n), Ke(this._backdrop).appendTo(document.body), Ke(this._element).on(Je.CLICK_DISMISS, function (e) {
                        t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                    }), n && En.reflow(this._backdrop), Ke(this._backdrop).addClass(it), !e) return;
                    if (!n) return void e();
                    var i = En.getTransitionDurationFromElement(this._backdrop);
                    Ke(this._backdrop).one(En.TRANSITION_END, e).emulateTransitionEnd(i)
                } else if (!this._isShown && this._backdrop) {
                    Ke(this._backdrop).removeClass(it);
                    var r = function () {
                        t._removeBackdrop(), e && e()
                    };
                    if (Ke(this._element).hasClass(nt)) {
                        var o = En.getTransitionDurationFromElement(this._backdrop);
                        Ke(this._backdrop).one(En.TRANSITION_END, r).emulateTransitionEnd(o)
                    } else r()
                } else e && e()
                ...
                if (this._isBodyOverflowing) {
                    Ke(rt.FIXED_CONTENT).each(function (t, n) {
                        var i = Ke(n)[0].style.paddingRight, r = Ke(n).css("padding-right");
                        Ke(n).data("padding-right", i).css("padding-right", parseFloat(r) + e._scrollbarWidth + "px")
                    }), Ke(rt.STICKY_CONTENT).each(function (t, n) {
                        var i = Ke(n)[0].style.marginRight, r = Ke(n).css("margin-right");
                        Ke(n).data("margin-right", i).css("margin-right", parseFloat(r) - e._scrollbarWidth + "px")
                    }), Ke(rt.NAVBAR_TOGGLER).each(function (t, n) {
                        var i = Ke(n)[0].style.marginRight, r = Ke(n).css("margin-right");
                        Ke(n).data("margin-right", i).css("margin-right", parseFloat(r) + e._scrollbarWidth + "px")
                    });
                    var t = document.body.style.paddingRight, n = Ke(document.body).css("padding-right");
                    Ke(document.body).data("padding-right", t).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")
                }
            }, t._resetScrollbar = function () {
                Ke(rt.FIXED_CONTENT).each(function (e, t) {
                    var n = Ke(t).data("padding-right");
                    void 0 !== n && Ke(t).css("padding-right", n).removeData("padding-right")
                }), Ke(rt.STICKY_CONTENT + ", " + rt.NAVBAR_TOGGLER).each(function (e, t) {
                    var n = Ke(t).data("margin-right");
                    void 0 !== n && Ke(t).css("margin-right", n).removeData("margin-right")
                });
                var e = Ke(document.body).data("padding-right");
                void 0 !== e && Ke(document.body).css("padding-right", e).removeData("padding-right")
                ...
                return this.each(function () {
                    var i = Ke(this).data(Qe), r = o({}, e.Default, Ke(this).data(), "object" == typeof t && t);
                    if (i || (i = new e(this, r), Ke(this).data(Qe, i)), "string" == typeof t) {
                        if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                        i[t](n)
        ...
        }(), Ke(document).on(Je.CLICK_DATA_API, rt.DATA_TOGGLE, function (e) {
            var t, n = this, i = En.getSelectorFromElement(this);
            i && (t = Ke(i)[0]);
            var r = Ke(t).data(Qe) ? "toggle" : o({}, Ke(t).data(), Ke(this).data());
            "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
            var s = Ke(t).one(Je.SHOW, function (e) {
                e.isDefaultPrevented() || s.one(Je.HIDDEN, function () {
                    Ke(n).is(":visible") && n.focus()
                })
            });
            ot._jQueryInterface.call(Ke(t), r, this)
        }), Ke.fn[$e] = ot._jQueryInterface, Ke.fn[$e].Constructor = ot, Ke.fn[$e].noConflict = function () {
            return Ke.fn[$e] = Ge, ot._jQueryInterface
        }, ot),
        Nn = (at = "tooltip", ut = "." + (lt = "bs.tooltip"), ct = (st = t).fn[at], ft = "bs-tooltip", ht = new RegExp("(^|\\s)" + ft + "\\S+", "g"), gt = {
            animation: !0,
        ...
        }, _t = "fade", bt = "show", Tt = ".tooltip-inner", Et = ".arrow", Ct = "hover", wt = "focus", xt = "click", Dt = "manual", St = function () {
            function e(e, t) {
            ...
            return t.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var r = this.getTipElement(), o = En.getUID(this.constructor.NAME);
                    ...
                    st(r).data(this.constructor.DATA_KEY, this), st.contains(this.element.ownerDocument.documentElement, this.tip) || st(r).appendTo(l), st(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new n(this.element, r, {
                        placement: a,
                        modifiers: {
                    ...
                    if (st(this.tip).hasClass(_t)) {
                        var c = En.getTransitionDurationFromElement(this.tip);
                        st(this.tip).one(En.TRANSITION_END, u).emulateTransitionEnd(c)
                    } else u()
                }
            }, t.hide = function (e) {
                var t = this, n = this.getTipElement(), i = st.Event(this.constructor.Event.HIDE), r = function () {
                ...
                if (st(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (st(n).removeClass(bt), "ontouchstart" in document.documentElement && st(document.body).children().off("mouseover", null, st.noop), this._activeTrigger[xt] = !1, this._activeTrigger[wt] = !1, this._activeTrigger[Ct] = !1, st(this.tip).hasClass(_t)) {
                        var o = En.getTransitionDurationFromElement(n);
                        st(n).one(En.TRANSITION_END, r).emulateTransitionEnd(o)
                    } else r();
                    this._hoverState = ""
                }
            }, t.update = function () {
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || st(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), st(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? wt : Ct] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = vt, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                ...
                return "number" == typeof (e = o({}, this.constructor.Default, st(this.element).data(), e)).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), En.typeCheckConfig(at, e, this.constructor.DefaultType), e
                ...
                return this.each(function () {
                    var n = st(this).data(lt), i = "object" == typeof t && t;
        ...
        }(), st.fn[at] = St._jQueryInterface, st.fn[at].Constructor = St, st.fn[at].noConflict = function () {
            return st.fn[at] = ct, St._jQueryInterface
        }, St),
        In = (Nt = "popover", kt = "." + (It = "bs.popover"), Ot = (At = t).fn[Nt], jt = "bs-popover", Lt = new RegExp("(^|\\s)" + jt + "\\S+", "g"), Pt = o({}, Nn.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Ht = o({}, Nn.DefaultType, {content: "(string|element|function)"}), Rt = "fade", Mt = ".popover-header", qt = ".popover-body", Wt = {
            HIDE: "hide" + kt,
            HIDDEN: "hidden" + kt,
            SHOW: (Ft = "show") + kt,
            SHOWN: "shown" + kt,
            ...
            return o.isWithContent = function () {
                ...
                At(this.getTipElement()).addClass(jt + "-" + e)
                ...
                "function" == typeof t && (t = t.call(this.element)), this.setElementContent(e.find(qt), t), e.removeClass(Rt + " " + Ft)
            }, o._getContent = function () {
                return this.element.getAttribute("data-content") || this.config.content
            }, o._cleanTipClass = function () {
                var e = At(this.getTipElement()), t = e.attr("class").match(Lt);
                null !== t && 0 < t.length && e.removeClass(t.join(""))
            }, t._jQueryInterface = function (e) {
                return this.each(function () {
                    var n = At(this).data(It), i = "object" == typeof e ? e : null;
                    if ((n || !/destroy|hide/.test(e)) && (n || (n = new t(this, i), At(this).data(It, n)), "string" == typeof e)) {
        ...
        }(Nn), At.fn[Nt] = Bt._jQueryInterface, At.fn[Nt].Constructor = Bt, At.fn[Nt].noConflict = function () {
            return At.fn[Nt] = Ot, Bt._jQueryInterface
        }, Bt), kn = (Vt = "scrollspy", $t = "." + (Kt = "bs.scrollspy"), Qt = (Ut = t).fn[Vt], Yt = {
            offset: 10,
            method: "auto",
            target: ""
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? en : tn,
                    n = "auto" === this._config.method ? t : this._config.method, i = n === tn ? this._getScrollTop() : 0;
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), Ut.makeArray(Ut(this._selector)).map(function (e) {
                    var t, r = En.getSelectorFromElement(e);
                    if (r && (t = Ut(r)[0]), t) {
                        var o = t.getBoundingClientRect();
                        if (o.width || o.height) return [Ut(t)[n]().top + i, r]
                    }
                    return null
                }).filter(function (e) {
                    return e
                ...
                Ut.removeData(this._element, Kt), Ut(this._scrollElement).off($t), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function (e) {
                if ("string" != typeof (e = o({}, Yt, e)).target) {
                    var t = Ut(e.target).attr("id");
                    t || (t = En.getUID(Vt), Ut(e.target).attr("id", t)), e.target = "#" + t
                }
                return En.typeCheckConfig(Vt, e, Gt), e
                ...
                var n = Ut(t.join(","));
                n.hasClass(zt) ? (n.closest(Zt.DROPDOWN).find(Zt.DROPDOWN_TOGGLE).addClass(Jt), n.addClass(Jt)) : (n.addClass(Jt), n.parents(Zt.NAV_LIST_GROUP).prev(Zt.NAV_LINKS + ", " + Zt.LIST_ITEMS).addClass(Jt), n.parents(Zt.NAV_LIST_GROUP).prev(Zt.NAV_ITEMS).children(Zt.NAV_LINKS).addClass(Jt)), Ut(this._scrollElement).trigger(Xt.ACTIVATE, {relatedTarget: e})
            }, t._clear = function () {
                Ut(this._selector).filter(Zt.ACTIVE).removeClass(Jt)
            }, e._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = Ut(this).data(Kt);
                    if (n || (n = new e(this, "object" == typeof t && t), Ut(this).data(Kt, n)), "string" == typeof t) {
                        if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                        n[t]()
                    }
                })
        ...
        }(), Ut(window).on(Xt.LOAD_DATA_API, function () {
            for (var e = Ut.makeArray(Ut(Zt.DATA_SPY)), t = e.length; t--;) {
                var n = Ut(e[t]);
                nn._jQueryInterface.call(n, n.data())
            }
        }), Ut.fn[Vt] = nn._jQueryInterface, Ut.fn[Vt].Constructor = nn, Ut.fn[Vt].noConflict = function () {
            return Ut.fn[Vt] = Qt, nn._jQueryInterface
        }, nn), On = (sn = "." + (on = "bs.tab"), an = (rn = t).fn.tab, ln = {
            HIDE: "hide" + sn,
            HIDDEN: "hidden" + sn,
            SHOW: "show" + sn,
            SHOWN: "shown" + sn,
            CLICK_DATA_API: "click" + sn + ".data-api"
        }, un = "dropdown-menu", cn = "active", fn = "disabled", hn = "fade", dn = "show", pn = ".dropdown", gn = ".nav, .list-group", mn = ".active", vn = "> li > .active", yn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', _n = ".dropdown-toggle", bn = "> .dropdown-menu .active", Tn = function () {
            function e(e) {
                this._element = e
            }
            ...
            return t.show = function () {
                var e = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && rn(this._element).hasClass(cn) || rn(this._element).hasClass(fn))) {
                    var t, n, i = rn(this._element).closest(gn)[0], r = En.getSelectorFromElement(this._element);
                    if (i) {
                        var o = "UL" === i.nodeName ? vn : mn;
                        n = (n = rn.makeArray(rn(i).find(o)))[n.length - 1]
                    }
                    var s = rn.Event(ln.HIDE, {relatedTarget: this._element}), a = rn.Event(ln.SHOW, {relatedTarget: n});
                    if (n && rn(n).trigger(s), rn(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var l = function () {
                            var t = rn.Event(ln.HIDDEN, {relatedTarget: e._element}),
                                i = rn.Event(ln.SHOWN, {relatedTarget: n});
                ...
                var i = this, r = ("UL" === t.nodeName ? rn(t).find(vn) : rn(t).children(mn))[0],
                    o = n && r && rn(r).hasClass(hn), s = function () {
                        return i._transitionComplete(e, r, n)
                    };
                if (r && o) {
                    var a = En.getTransitionDurationFromElement(r);
                    rn(r).one(En.TRANSITION_END, s).emulateTransitionEnd(a)
                } else s()
    ...
    }(t), e.Util = En, e.Alert = Cn, e.Button = wn, e.Carousel = xn, e.Collapse = Dn, e.Dropdown = Sn, e.Modal = An, e.Popover = In, e.Scrollspy = kn, e.Tab = On, e.Tooltip = Nn, Object.defineProperty(e, "__esModule", {value: !0})
});
